...
from handlers.dtos.v1_cabinet_document_comments_all_get import V1CabinetDocumentCommentAllResponse
...
class V1CabinetDocumentGetResponse(BaseModel):
    ...
    comments: list[V1CabinetDocumentCommentAllResponse] = Field(
