            ...
            [
                {
                    ...
                    "user_id": 1,
                    "reply_to": pd.NA,
                    "remark": "Начальный статус проверки",
                    "proposal": "Изменить формирование разделов и именование параграфов",
                    "justification": pd.NA,
                ...
                },
                {
                    ...
                    "reply_to": 1,
                    "remark": "LGTM",
                    "proposal": "Требуется изменение политик персональных данных",
                    "justification": pd.NA,
                    "developer_response": "Правки приняты",
                    "xfdf": "",
                    "status": pd.NA,
                    "is_viewed": False,
                ...
                },
                {
                    ...
                    "reply_to": pd.NA,
                    "remark": "Нет тестов",
                    "proposal": "Требуется провести интеграционное тестирование",
                    "justification": pd.NA,
                    "developer_response": pd.NA,
                    "xfdf": "",
                    "status": pd.NA,
